...
// Drives F-042 end to end: draw a border (one piece), paint a glass, number it, open the
// Manufacturing dock, and export both the PDF and CSV cutting list / BOM to disk.
test('exports the cutting list & BOM as PDF and CSV from the Manufacturing dock', async () => {
  ...
  // The cutting list is live in the panel.
