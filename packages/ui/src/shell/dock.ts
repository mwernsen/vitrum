...
// Export dialog opened from the top bar (F-043), not the dock. "light" hosts the sunlight simulation
// (F-054); "versions" hosts the version browser and sharing (F-055).
